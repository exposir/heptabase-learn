<!--
- [INPUT]: 依赖 /CLAUDE.md 的专题上下文
- [OUTPUT]: 本子目录的模块地图与成员清单
- [POS]: L2 层级文档，描述 "RDK" (Layout-Box) 专题
...
- **Layout-Box渲染引擎深度剖析.md**: 核心研报。涵盖 Monorepo 结构、核心包职责（CDK/Palouti/Pingere）、React Reconciler 绑定与硬件加速方案。
